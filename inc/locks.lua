...
return sendMsg(msg.chat_id_,msg.id_,"⇠ الروابط مقفل من قبل    \n⇠  من「 "..NameUser.." 」 " ) 
else
...
return sendMsg(msg.chat_id_,msg.id_,"⇠ البوتات مقفل من قبل    \n⇠  من「 "..NameUser.." 」 " ) 
else
...
return sendMsg(msg.chat_id_,msg.id_,"⇠ الصور مقفل من قبل    \n⇠  من「 "..NameUser.." 」 " ) 
else
