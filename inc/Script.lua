...
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"-معليشً هذا العضو ليس موجود ضمن المجموعات\n") end
...
return "⇠ مايمديك التثبيت الامر مقفول من قبل الاداره"
else
tdcli_function({
...
if not msg.Admin then return "⇠ هذا الامر يخص ( الادمن,المدير,المالك,المطور ) بس  \n" end
if not msg.Director and redis:get(boss..'lock_pin'..msg.chat_id_) then return "⇠ مايمديك الغاء التثبيت الامر مقفول من قبل الاداره" end
...
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⇠ العضو مو موجود في المجموعه اصلا!") end
local UserID = data.sender_user_id_
if UserID == our_id then  
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تقيد البوت ") 
elseif UserID == 1718587141 or UserID == 1910934437  then  
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تقيد Legend ") 
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تقيد Mishary ") 
...
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تقيد المنشئ ") 
elseif redis:sismember(boss..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تقيد المالك ") 
elseif redis:sismember(boss..':Malk_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تقيد المالك اساسي ") 
elseif redis:sismember(boss..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تقيد المدير ") 
elseif redis:sismember(boss..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تقيد الادمن ") 
elseif  redis:sismember(boss..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تقيد المميز ") 
end
...
sendMsg(arg.ChatID,arg.MsgID,"⇠ العضو مو موجود في المجموعه اصلا!") 
else
...
Restrict(arg.ChatID,arg.UserID,1)  
elseif data.status_.ID == "ChatMemberStatusLeft" then
sendMsg(arg.ChatID,arg.MsgID,"⇠ مقدر تقيد العضو لانه مغادر المجموعة ") 
else
sendMsg(arg.ChatID,arg.MsgID,'⇠ مقدر تقييد العضو\n⇠ لانه مشرف \n𓍦')    
end
...
UserID =  MsgText[2] 
if UserID == our_id then   
return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تقيد البوت ") 
elseif UserID == "1718587141" or UserID == "1910934437" then 
return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تقيد Legend ") 
elseif UserID == tostring(SUDO_ID) then 
return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تقيد Mishary ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تقيد المطور ") 
elseif redis:sismember(boss..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تقيد المنشئ ") 
elseif redis:sismember(boss..':MONSHA_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تقيد المالك ") 
elseif redis:sismember(boss..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تقيد المدير ") 
elseif redis:sismember(boss..'admins:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تقيد الادمن ") 
end
...
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⇠ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تنفيذ الامر بالرد ع رسالة البوت") end
...
GetChatMember(arg.ChatID,our_id,function(arg,data)
if data.status_.ID ~= "ChatMemberStatusEditor" then 
return sendMsg(arg.ChatID,arg.MsgID,'⇠ مقدر تقييد العضو\n⇠ لانني لست مشرف \n𓍦')    
end
...
GetChatMember(arg.ChatID,our_id,function(arg,data)
if data.status_.ID ~= "ChatMemberStatusEditor" then 
return sendMsg(arg.ChatID,arg.MsgID,'⇠ مقدر قك تقييد العضو\n⇠ لانني لست مشرف \n𓍦')    
end
redis:del(boss..":TqeedUser:"..arg.ChatID..arg.UserID)
Restrict(arg.ChatID,arg.UserID,2)
sendMsg(arg.ChatID,arg.MsgID,"⇠ العضو「 "..NameUser.." 」 \n⇠ تم فك تقييده  من المجموعه") 
...
if not data.sender_user_id_ then return sendMsg(ChatID,MsgID,"⇠ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تنفيذ الامر بالرد ع رسالة البوت") end
GetUserID(UserID,function(arg,data)
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
...
local UserID = data.sender_user_id_
if UserID == our_id then   
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تطرد البوت ") 
elseif UserID == 1718587141 or UserID == 1910934437 then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تطرد Legend") 
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تطرد Mishary ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تطرد المطور ") 
elseif redis:sismember(boss..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تطرد المنشئ ") 
elseif redis:sismember(boss..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تطرد المالك ") 
elseif redis:sismember(boss..':Malk_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تطرد المالك اساسي ") 
elseif redis:sismember(boss..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"- ⇠ مايمديك تطرد المدير ") 
elseif redis:sismember(boss..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تطرد الادمن ") 
elseif  redis:sismember(boss..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تطرد المميز ") 
end
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
return sendMsg(arg.ChatID,arg.MsgID,'⇠ مقدر حظر العضو .\n⇠ لانه مشرف \n𓍦  ')    
...
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
return sendMsg(arg.ChatID,arg.MsgID,'⇠ مقدر طرد العضو .\n⇠ لانه مشرف \n𓍦  ')    
elseif data.ID == "Error" and data.code_ == 3 then
return sendMsg(arg.ChatID,arg.MsgID,'⇠ مقدر طرد العضو .\n ⇠ ليس لدي صلاحيه الحظر او لست مشرف ')    
end
StatusLeft(arg.ChatID,arg.UserID)
...
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر Mishary ") 
elseif UserID == 1718587141 or UserID == 1910934437 then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر Legend ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر المطور ") 
elseif redis:sismember(boss..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر المنشئ ") 
elseif redis:sismember(boss..':Malk_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر المالك اساسي ") 
elseif redis:sismember(boss..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر المالك ") 
elseif redis:sismember(boss..':Malk_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر المالك اساسي ") 
elseif redis:sismember(boss..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر المدير ") 
elseif redis:sismember(boss..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر الادمن ") 
elseif  redis:sismember(boss..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تحظر المميز ")
end
...
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"⇠ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك استخدام الامر بالرد على البوت \n") end
GetUserID(UserID,function(arg,data)
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
...
GetUserName(MsgText[2],function(arg,data)
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"⇠ مافيه عضو بذا اليوزر!") end 
if data.id_ == our_id then return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تنفيذ الامر مع البوت \n") end 
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"⇠ مافيه عضو باليوزر ذا!") end
local UserID = data.id_
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
...
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تكتم Mishary ") 
elseif UserID == 1718587141 or UserID == 1910934437 then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تكتم Legend ") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تكتم المطور ") 
elseif redis:sismember(boss..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تكتم المنشئ ") 
elseif redis:sismember(boss..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تكتم المالك ") 
elseif redis:sismember(boss..':Malk_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تكتم المالك اساسي ") 
elseif redis:sismember(boss..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تكتم المدير ") 
elseif redis:sismember(boss..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تكتم الادمن ") 
elseif  redis:sismember(boss..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⇠ مايمديك تكتم المميز  ") 
end
GetUserID(UserID,function(arg,data)
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"⇠ مافيه عضو باليوزر ذا!") end
USERNAME = ResolveUserName(data)
...
if not MsgText[2] and msg.reply_id then 
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(msg.chat_id_,msg.id_,"⇠ معليش هذا العضو ليس موجود ضمن المجموعات") end
local UserID = data.sender_user_id_
msg = arg.msg
msg.UserID = UserID
GetUserID(UserID,function(arg,data)
...
function senddwon() sendMsg(msg.chat_id_,msg.id_,"⇠ رتبته اعلى منك مايمديك تنزله! ") end
function sendpluse() sendMsg(msg.chat_id_,msg.id_,"⇠ معليش مقدر تنزيل رتبه مثل رتبتك : "..msg.TheRankCmd.." ") end

if rinkuser == 9 then return sendMsg(msg.chat_id_,msg.id_,"⇠ العضو「 "..NameUser.." 」   \nهذا عضو من قبل ")  end
huk = false
...
msg = arg.msg
if UserID == 1718587141 or UserID == 1910934437 then return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تنزل Legend! ") end
NameUser = Hyper_Link_Name(data)
...
return "⇠ تمام عيني\n⇠ الحين ارسل معرف العضو لنقل ملكية البوت له ."
end
...
if not msg.SudoUser then return "⇠ هذا الامر يخص ( المطور ) بس  \n" end
if not msg.SudoBase and not redis:get(boss.."lockidedit") then return "⇠ الامر معطل من قبل Mishary  \n" end
redis:del(boss..":infoiduser")
return sendMsg(msg.chat_id_,msg.id_,"⇠ تم مسحت كليشة الايدي العام  ")
end
...
if not msg.SudoUser then return "⇠ هذا الامر يخص ( المطور ) بس  \n" end
if not msg.SudoBase and not redis:get(boss.."lockidedit") then return "⇠ تعيين الايدي معطل من قبل Mishary  \n" end
...
return "⇠ الاذاعه مقفوله من قبل Mishary  " 
end
...
return " تم مسحت كل الردود العامه"
else
...
if MsgText[1] == "/Commands@D0Bot" or MsgText[1] == "/Commands" or  MsgText[1] == "الاوامر" then
if not msg.Admin then return "- هذا الامر يخص ( الادمن,المدير,المالك,المطور) بس  \n" end
...
if not msg.SudoBase then return " ⇠ هذا الامر يخص ( Mishary ) بس " end
SUDO_USER = redis:hgetall(boss..'username:'..SUDO_ID).username
...
if not data.id_ then return sendMsg(ChatID,MsgID,"⇠ العضو مافيه ") end
local UserID = data.id_
local Resolv = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if UserID == 1718587141 or UserID == 1910934437 then 
return sendMsg(ChatID,MsgID,"⇠ مايمديك تحظر Legend ") 
end
if redis:sismember(boss..'bannedpv',UserID) then 
...
if FwdUser == 1718587141 or FwdUser == 1910934437 then 
return sendMsg(arg.ChatID,arg.id_,"⇠ مايمديك تحظر Legend ") 
end
redis:hset(boss..'username:'..arg.FwdUser,'username',USERNAME)
if redis:sismember(boss..'bannedpv',FwdUser) then 
return sendMsg(arg.ChatID,arg.id_,"⇠ العضو「 ["..USERNAME.."] 」 \n⇠ تم بالتاكيد حظره  من التواصل") 
end
...
.."⇠ صلاحيه حظر وتقيدالعضوين : "..infochange3.."\n"
...
if msg.text ~= "Mishary" and msg.text ~= "مطور" and msg.text ~= "مالك" and msg.text ~= "منشئ" and msg.text ~= "مدير" and msg.text ~= "ادمن" and msg.text ~= "مميز" then
sendMsg(msg.chat_id_,msg.id_,"معليش هذه الرتبه غير متوفره في السورس \n⇠ تم الغاء الامر")
return false
end

if msg.text == "Mishary" then
redis:del(boss..":RtbaNew1:"..msg.chat_id_)
...
if msg.text ~= "Mishary" and msg.text ~= "مالك اساسي"  and msg.text ~= "مطور" and msg.text ~= "مالك" and msg.text ~= "منشئ" and msg.text ~= "مدير" and msg.text ~= "ادمن" and msg.text ~= "مميز" then
sendMsg(msg.chat_id_,msg.id_,"معليش هذه الرتبه غير متوفره في السورس \n⇠ تم الغاء الامر")
return false
end
