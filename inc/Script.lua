...
sendMsg(msg.chat_id_,msg.id_,' ['..info.username..'](t.me/ LIINN8)  \n')
end
...
elseif UserID == 1732671454 or UserID == 60809019  then  
...
if UserID == 1732671454 or UserID == 60809019 then return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تنزل مطور الاساسي! \n") end
...
msg = arg.msg
if UserID == 1732671454 or UserID == 60809019 then return sendMsg(msg.chat_id_,msg.id_,"⇠ مايمديك تنزل مطور! ") end
NameUser = Hyper_Link_Name(data)
...
return '⇠ اصدار سورس لينك : *v'..version..'* '
end
...
sendMsg(arg.chat_id_,arg.id_,'⇠ معليش اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس لينك يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : لينك ",url="t.me/LIINN8"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: آرماندو](t.me/LIINN8)',nil,inline,msg.id_)
return false
end
...
NameUser = Hyper_Link_Name(data)
if UserID == 1732671454 or UserID == 60809019 then 
...
if FwdUser == 1732671454 or FwdUser == 60809019 then 
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"⇠ معليش هذا الحساب محظور من سيرفرات حماية لينك ") end
