...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1732671454 or msg.sender_user_id_ == 1930359414 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/NlII1/ee6ee/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/NlII1/ee6ee/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/NlII1/ee6ee/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/NlII1/ee6ee/main/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/NlII1/ee6ee/main/plugins/games.lua','./plugins/games.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "لينك "
...
result = false
if msg.sender_user_id_ == 1732671454 or msg.sender_user_id_ == 1732671454 then 
SudoBase = true
...
var = 'هذا البوت' 
elseif UserID == 1732671454or UserID == 1732671454 then 
var = 'مطور السورس '
...
elseif UserID == 1732671454 or UserID == 1910934437 then 
...
elseif UserID == 1732671454 or UserID == 1732671454 then 
...
if UserID == 1910934437 or UserID == 1732671454 then return sendMsg(ChatID,MsgID,"⇠ مايمديك تنزل مطور السورس!") end
